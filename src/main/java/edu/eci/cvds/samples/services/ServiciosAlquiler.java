...
public interface ServiciosAlquiler {  
	...
	*@return el litado de detalle de los items rentados por el cliente *identificado con 'idcliente' 
	...
	*@throws ExcepcionServiciosAlquiler si el item no existe o no esta *actualmente alquilado */    
	...
	/** *@obj rejistrar el alkiler de unitem 
	*@pre numdias >=1 
	...
	*@param numdias el numero de dias que se le prestara el item *@pos el item ya no debe estar disponible, y debe estar asignado al    
	* cliente 
	*@throws ExcepcionXX si el identificador no corresponde con un item, o si *el mismo ya esta alquilado */ 
